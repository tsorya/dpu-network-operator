...
// Dependency issue, need to remove after https://github.com/medik8s/node-maintenance-operator/pull/74 will be pushed 
replace github.com/medik8s/node-maintenance-operator => github.com/tsorya/node-maintenance-operator v0.0.0-20230123170558-9ec931bbb702
